(function($){  
    $.fn.paginate = (function(options) {
        ...
        return this.each(function() {
            ...
            $('<li class="first"><a class="'+options.buttonClass+'" href="#">'+options.buttonFirst+'</a></li>').click(function(){
            ...
            $('<li class="last"><a class="'+options.buttonClass+'" href="#">'+options.buttonLast+'</a></li>').click(function(){
